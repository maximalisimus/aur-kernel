# aur-nvidia-340xx
# https://maximalisimus.github.io/aur-nvidia-340xx/

Драйвера AUR nvidia-340xx. Собранные в формат xz и zst пакеты для установки с помощью pacman.

Nvidia-340xx AUR drivers. Collected in the xz and zst format for packages to install via pacman.
